 ...
 */
public class KeySQLiteOpenHelperCallbacks {
    private static final String TAG = KeySQLiteOpenHelperCallbacks.class.getSimpleName();
  ...
  //      new KeySQLiteUpgradeHelper().onUpgrade(db, oldVersion, newVersion);
    }
}
